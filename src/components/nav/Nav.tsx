    ...
    <nav>
        <div className='w-full flex items-center px-2 justify-between'>
            ...
            <div className='flex gap-4 text-2xl text-gray-500 items-center'>
                <SlUser/>
                <AiOutlineMenu onClick={handleMenu}  className='border h-[30px] w-[30px] p-1'/>
            </div>
            
        </div>
        <ul className={`relative z-50 transition-transform duration-500 ${showMenu ? 'translate-x-0' : '-translate-x-full'}`}>
